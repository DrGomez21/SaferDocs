    ...
    <>
      ...
      <main className="flex flex-col justify-center items-center gap-4 px-6 max-w-5xl mx-auto">
        <section className="flex flex-col items-center gap-6">
          ...
          <button
            className="flex justify-center items-center gap-2 w-full bg-primary text-white font-poppins font-semibold text-sm px-4 py-3 rounded-lg max-w-xl hover:cursor-pointer sm:hover:scale-95 transition duration-100"
